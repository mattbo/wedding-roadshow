...
past = [
    ...
    'Moultonborough, NH',
    'Lyman, ME',
    'Rachel Carson Wildlife Reserve, ME',
    'Barreled Souls Brewing, Saco, ME',
    'Portland, ME',
    'Boothbay Harbor, ME',
    'Nobleborough, ME',
    ...
    'Nobleborough, ME',
    'Port Clyde, ME',
    'Seawall campground, Acadia National Park, ME',
    'Bass harborhead lighthouse, ME',
    'Ponds end boat ramp, Mt Desert, ME',
    'Seal Cove, ME',
    'Southwest Harbor, ME',
    ...
    'Sargeant Drive, Northwest Harbor, ME',
    'Bar Harbor, ME',
    'Quebec City, Quebec, Canada',
    'Observation Tower, Ile de Orleans, Quebec, Canada',
    'Saint-Laurent-Ile-de-Orleans, Quebec, Canada',
    'La Fromagerie Bergeron, Saint-Antoine-de-Tilly, Quebec, Canada',
    'Montreal, Canada',
    'Grenville, Canada',
    'Ottawa, Canada',
    'Lac Philippe, Sainte-Cecile-de-Masham, Quebec, Canada',
    'North Bay, Ontario, Canada',
    'Bridal Veil Falls, Billings, ON, Canada',
    'Lake Huron Fish and Chips, Providence Bay, ON, Canada',
    'Saulte Ste. Marie, Ontario, Canada'
    'Ferroclad Fishery, Batchawana Bay, ON, Canada',
    'Saulte Ste. Marie, Ontario, Canada'
]
